...
public class TitleCell: ScrollableTabsHeaderViewCell, ViewModelConfigurable {
    ...
    public func configure(for title: String) {
...
extension ViewController: TabConfiguratorType {
    ...
    public func widthForHeader(at index: Int) -> CGFloat {
        return 100
    }
}
